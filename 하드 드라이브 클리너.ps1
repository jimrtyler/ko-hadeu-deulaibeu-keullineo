...
#GUI Variables
$FormTitleText = "Jim Tyler의 디스크 클리너(PowerShellEngineer.com)"
$SelectDiskLabelText = "디스크 선택:"
$FreeSpaceLabelText = "여유 공간(기가바이트): "
$TotalSpaceLabelText = "총 공간(기가바이트): "
$JunkFoundLabelText = "가비지 발견(기가바이트):"
$CleanDiskBtnText = "디스크 청소 *파일 삭제*"
$SpaceCleanedLabelText = "청소된 공간(기가바이트): "
$LogFileLabelText = "위치한 로그 파일: $abcdefg"
$CreditLabelText = "Jim Tyler의 스크립트 - PowerShellEngineer.com"
$LogFileLocatedText = "로그 파일 위치"
$AnalyzingDriveText = "드라이브 분석 중..."
$BrowsersAreRunningText = "브라우저가 실행 중입니다... 사용자에게 알립니다..."
$PleaseCloseBrowsersText = "모든 웹 브라우저를 닫고 다시 시도하십시오."
$CleaningDriveText = "드라이브 청소 중..."
